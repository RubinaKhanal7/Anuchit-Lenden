...
@section('content')
    ...
    <form id="quickForm" novalidate="novalidate" method="POST" action="{{ route('admin.loangiving-victim.store') }}"
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number"
                               value="{{ old('loan_giving_application_registration.registration_id') }}"id="applicant_name" name="loan_giving_application_registration[registration_id]" class="input-text" autofocus min="1" required>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ old('loan_giving_application_registration.registration_date') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="loan_giving_applicant_basic_detail[applicant_name]"
                            class="input-text" autofocus value="{{ old('loan_giving_applicant_basic_detail.applicant_name') }}"
                            maxlength="50" required>                     
                                   @if ($errors->has('loan_giving_applicant_basic_detail.applicant_name'))
                                   <div class="alert alert-danger">
                                       <ul>
                                           @foreach ($errors->get('loan_giving_applicant_basic_detail.applicant_name') as $error)
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="number"
                                   value="{{ old('loan_giving_applicant_basic_detail.applicant_age') }}" id="age" name="loan_giving_applicant_basic_detail[applicant_age]" class="input-text" autofocus min="1" required>
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="number"
                                value="{{ old('loan_giving_applicant_basic_detail.applicant_citizenship') }}" id="" name="loan_giving_applicant_basic_detail[applicant_citizenship]" class="input-text" autofocus min="1" required>
                            ...
                            <select id="a_district_id" data-iteration="0"
                                ...
                                @foreach ($districts as $district)
                                    <option value="{{ $district->id }}"
                                        {{ old('loan_giving_applicant_basic_detail.applicant_citizenship_issue_district') == $district->id ? 'selected' : '' }}>
                                        {{ $district->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text"
                                value="{{ old('loan_giving_applicant_basic_detail.applicant_citizenship_issue_date') }}"id="citizenship-datepicker"
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text"
                                value="{{ old('loan_giving_applicant_basic_detail.applicant_fathername') }}"
                                id="" name="loan_giving_applicant_basic_detail[applicant_fathername]"
                                class="input-text" autofocus>
                                @if ($errors->has('loan_giving_applicant_basic_detail.applicant_fathername'))
                                   <div class="alert alert-danger">
                                       <ul>
                                           @foreach ($errors->get('loan_giving_applicant_basic_detail.applicant_fathername') as $error)
                                           <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                           @endforeach
                                       </ul>
                                   </div>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="number"
                                   value="{{ old('loan_giving_applicant_basic_detail.applicant_fathers_no') }}" id="applicant_fathers_no" name="loan_giving_applicant_basic_detail[applicant_fathers_no]" class="input-text"
                                   minlength="9" maxlength="10" placeholder="ex: ९८११११११११/०१-२३४५६८७" autofocus oninput="validatePhoneNumber(this, 'phoneNumberError')" min="1" required>
                            <span id="phoneNumberError" style="display: none; color: red;">कृपया ९/१० अंकको सही फोन नंबर प्रविष्ट गर्नुहोस्।</span>
                            @if ($errors->has('loan_giving_applicant_basic_detail.applicant_fathers_no'))
                                   <div class="alert alert-danger">
                                       <ul>
                                           @foreach ($errors->get('loan_giving_applicant_basic_detail.applicant_fathers_no') as $error)
                                           <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                           @endforeach
                                       </ul>
                                   </div>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text"
                                value="{{ old('loan_giving_applicant_basic_detail.applicant_spouse') }}" id=""
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label for="applicant_spouse_no">फोन/मोबाईल नं </label>
                            <input type="number" value="{{ old('loan_giving_applicant_basic_detail.applicant_spouse_no') }}"
                                   id="applicant_spouse_no" name="loan_giving_applicant_basic_detail[applicant_spouse_no]"
                                   class="input-text" minlength="9" maxlength="10" placeholder="ex: ९८११११११११/०१-२३४५६८७" autofocus min="1" required
                                   oninput="validatePhoneNumber(this, 'phoneNumberError1')">
                            <span id="phoneNumberError1" style="display: none; color: red;">कृपया ९/१० अंकको सही फोन नंबर प्रविष्ट गर्नुहोस्।</span>
                        </div>
                    </div>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="number"
                                value="{{ old('loan_giving_applicant_basic_detail.applicant_family') }}" id=""
                                ...
                                @if ($errors->has('loan_giving_applicant_basic_detail.applicant_family'))
                                   <div class="alert alert-danger">
                                       <ul>
                                           @foreach ($errors->get('loan_giving_applicant_basic_detail.applicant_family') as $error)
                                           <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                           @endforeach
                                       </ul>
                                   </div>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <select id="annual_income" name="loan_giving_applicant_basic_detail[applicant_annual_income]" class="form-control" autofocus>
                                <option value="" disabled {{ old('loan_giving_applicant_basic_detail.applicant_annual_income') == '' ? 'selected' : '' }}>वार्षिक आम्दानी चयन गर्नुहोस्</option>
                                <option  {{ old('loan_giving_applicant_basic_detail.applicant_annual_income') == '१ लाख देखि  ५ लाख' ? 'selected' : '' }}>१ लाख देखि  ५ लाख</option>
                                <option  {{ old('loan_giving_applicant_basic_detail.applicant_annual_income') == '५ लाख देखि १० लाख' ? 'selected' : '' }}>५ लाख देखि १० लाख</option>
                                <option  {{ old('loan_giving_applicant_basic_detail.applicant_annual_income') == '१० लाख देखि  २० लाख' ? 'selected' : '' }}>१० लाख देखि  २० लाख</option>
                                <option  {{ old('loan_giving_applicant_basic_detail.applicant_annual_income') == '२० लाख +' ? 'selected' : '' }}>२० लाख +</option>
                            </select>
                            @if ($errors->has('loan_giving_applicant_basic_detail.applicant_annual_income'))
                                   <div class="alert alert-danger">
                                       <ul>
                                           @foreach ($errors->get('loan_giving_applicant_basic_detail.applicant_annual_income') as $error)
                                           <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                           @endforeach
                                       </ul>
                                   </div>
                            ...
                            <select id="state_id0" name="loan_giving_applicant_basic_detail[applicant_permanent_state]"
                                ...
                                @foreach ($states as $state)
                                    <option value="{{ $state->id }}"
                                        {{ old('loan_giving_applicant_basic_detail.applicant_permanent_state') == $state->id ? 'selected' : '' }}>
                                        {{ $state->name }}</option>
                                @endforeach
                            </select>
                            @if ($errors->has('loan_giving_applicant_basic_detail.applicant_name'))
                                   <div class="alert alert-danger">
                                       <ul>
                                           @foreach ($errors->get('loan_giving_applicant_basic_detail.applicant_permanent_state') as $error)
                                           <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                           @endforeach
                                       </ul>
                                   </div>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select id="a_district_id0" data-iteration="0"
                                ...
                                @foreach ($districts as $district)
                                    <option value="{{ $district->id }}"
                                        {{ old('loan_giving_applicant_basic_detail.applicant_permanent_district') == $district->id ? 'selected' : '' }}>
                                        {{ $district->name }}
                                    </option>
                                @endforeach
                            </select>
                            @if ($errors->has('loan_giving_applicant_basic_detail.applicant_permanent_district'))
                                   <div class="alert alert-danger">
                                       <ul>
                                           @foreach ($errors->get('loan_giving_applicant_basic_detail.applicant_permanent_district') as $error)
                                           <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                           @endforeach
                                       </ul>
                                   </div>
                            ...
                            <select id="a_localbody_id0" data-iteration="0"
                                ...
                                @foreach ($locals as $localbody)
                                    <option value="{{ $localbody->id }}"
                                        {{ old('loan_giving_applicant_basic_detail.applicant_permanent_local') == $localbody->id ? 'selected' : '' }}>
                                        {{ $localbody->name }}
                                    </option>
                                @endforeach
                            </select>
                            @if ($errors->has('loan_giving_applicant_basic_detail.applicant_permanent_local'))
                                   <div class="alert alert-danger">
                                       <ul>
                                           @foreach ($errors->get('loan_giving_applicant_basic_detail.applicant_permanent_local') as $error)
                                           <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                           @endforeach
                                       </ul>
                                   </div>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select id="a_wada_id" name="loan_giving_applicant_basic_detail[applicant_permanent_ward]"
                                ...
                                @for ($i = 1; $i <= 32; $i++)
                                    <option value="{{ $i }}"
                                        {{ old('loan_giving_applicant_basic_detail.applicant_permanent_ward') == $i ? 'selected' : '' }}>
                                        वडा नं. {{ $i }}</option>
                                @endfor
                            </select>
                            @if ($errors->has('loan_giving_applicant_basic_detail.applicant_permanent_ward'))
                                   <div class="alert alert-danger">
                                       <ul>
                                           @foreach ($errors->get('loan_giving_applicant_basic_detail.applicant_permanent_ward') as $error)
                                           <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                           @endforeach
                                       </ul>
                                   </div>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select id="state_id1" name="loan_giving_applicant_basic_detail[applicant_temp_state]"
                                ...
                                @foreach ($states as $state)
                                    <option value="{{ $state->id }}"
                                        {{ old('loan_giving_applicant_basic_detail.applicant_temp_state') == $state->id ? 'selected' : '' }}>
                                        {{ $state->name }}</option>
                                @endforeach
                            </select>
                            @if ($errors->has('loan_giving_applicant_basic_detail.applicant_temp_state'))
                                   <div class="alert alert-danger">
                                       <ul>
                                           @foreach ($errors->get('loan_giving_applicant_basic_detail.applicant_temp_state') as $error)
                                           <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                           @endforeach
                                       </ul>
                                   </div>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select id="o_district_id1" data-iteration="1"
                                ...
                                @foreach ($districts as $district)
                                    <option value="{{ $district->id }}"
                                        {{ old('loan_giving_applicant_basic_detail.applicant_temp_district') == $district->id ? 'selected' : '' }}>
                                        {{ $district->name }}
                                    </option>
                                @endforeach
                            </select>
                            @if ($errors->has('loan_giving_applicant_basic_detail.applicant_temp_district'))
                                   <div class="alert alert-danger">
                                       <ul>
                                           @foreach ($errors->get('loan_giving_applicant_basic_detail.applicant_temp_district') as $error)
                                           <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                           @endforeach
                                       </ul>
                                   </div>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select id="o_localbody_id1" data-iteration="1"
                                ...
                                @foreach ($locals as $localbody)
                                    <option value="{{ $localbody->id }}"
                                        {{ old('loan_giving_applicant_basic_detail.applicant_temp_local') == $localbody->id ? 'selected' : '' }}>
                                        {{ $localbody->name }}
                                    </option>
                                @endforeach
                            </select>
                            @if ($errors->has('loan_giving_applicant_basic_detail.applicant_temp_local'))
                                   <div class="alert alert-danger">
                                       <ul>
                                           @foreach ($errors->get('loan_giving_applicant_basic_detail.applicant_temp_local') as $error)
                                           <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                           @endforeach
                                       </ul>
                                   </div>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select id="a_wada_id" name="loan_giving_applicant_basic_detail[applicant_temp_ward]"
                                ...
                                @for ($i = 1; $i <= 32; $i++)
                                    <option value="{{ $i }}"
                                        {{ old('loan_giving_applicant_basic_detail.applicant_temp_ward') == $i ? 'selected' : '' }}>
                                        वडा नं. {{ $i }}</option>
                                @endfor
                            </select>
                        </div>
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="number" value="{{ old('loan_giving_applicant_basic_detail.applicant_pan') }}"
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <select id="occupation" name="loan_giving_applicant_basic_detail[applicant_occup]" class="form-control" autofocus>
                                ...
                                <option {{ old('loan_giving_applicant_basic_detail.applicant_occup') == 'शिक्षक' ? 'selected' : '' }}>शिक्षक</option>
                                <option {{ old('loan_giving_applicant_basic_detail.applicant_occup') == 'अभियंता' ? 'selected' : '' }}>अभियंता</option>
                                <option {{ old('loan_giving_applicant_basic_detail.applicant_occup') == 'डॉक्टर' ? 'selected' : '' }}>डॉक्टर</option>
                                <option {{ old('loan_giving_applicant_basic_detail.applicant_occup') == 'वकील' ? 'selected' : '' }}>वकील</option>
                                <option {{ old('loan_giving_applicant_basic_detail.applicant_occup') == 'व्यवसाय' ? 'selected' : '' }}>व्यवसाय</option>
                                <option {{ old('loan_giving_applicant_basic_detail.applicant_occup') == 'किसान' ? 'selected' : '' }}>किसान</option>
                                <option {{ old('loan_giving_applicant_basic_detail.applicant_occup') == 'अन्य' ? 'selected' : '' }}>अन्य</option>
                            </select>
                            @if ($errors->has('loan_giving_applicant_basic_detail.applicant_occup'))
                                   <div class="alert alert-danger">
                                       <ul>
                                           @foreach ($errors->get('loan_giving_applicant_basic_detail.applicant_occup') as $error)
                                           <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                           @endforeach
                                       </ul>
                                   </div>
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <select id="" name="loan_giving_applicant_basic_detail[applicant_edu]"
                                ...
                                <option
                                    {{ old('loan_giving_applicant_basic_detail.applicant_edu') == 'सामान्य लेखपढ' ? 'selected' : '' }}>
                                    सामान्य लेखपढ</option>
                                <option
                                    {{ old('loan_giving_applicant_basic_detail.applicant_edu') == 'कक्षा ८ सम्म' ? 'selected' : '' }}>
                                    कक्षा ८ सम्म</option>
                                <option
                                    {{ old('loan_giving_applicant_basic_detail.applicant_edu') == 'कक्षा १० सम्म' ? 'selected' : '' }}>
                                    कक्षा १० सम्म</option>
                                <option
                                    {{ old('loan_giving_applicant_basic_detail.applicant_edu') == 'कक्षा १२ सम्म' ? 'selected' : '' }}>
                                    कक्षा १२ सम्म</option>
                                <option
                                    {{ old('loan_giving_applicant_basic_detail.applicant_edu') == 'उच्च शिक्षा' ? 'selected' : '' }}>
                                    उच्च शिक्षा</option>
                                <option
                                    {{ old('loan_giving_applicant_basic_detail.applicant_edu') == 'निराक्षर' ? 'selected' : '' }}>
                                    निराक्षर</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="number" value="{{ old('loan_giving_applicant_finance_cond.home_no') }}"
                            ...
                            @if ($errors->has('loan_giving_applicant_finance_cond.home_no'))
                                   <div class="alert alert-danger">
                                       <ul>
                                           @foreach ($errors->get('loan_giving_applicant_finance_cond.home_no') as $error)
                                           <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                           @endforeach
                                       </ul>
                                   </div>
                    ...
                    <div class="row additional-fields-container">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" value="{{ old('loan_giving_applicant_finance_cond.home_area.0') }}"
                                       id="" name="loan_giving_applicant_finance_cond[home_area][]"
                                       class="input-text" autofocus min="1">
                                @php
                                    $homeAreaErrors = $errors->get('loan_giving_applicant_finance_cond.home_area.*');
                                @endphp
                                @if ($homeAreaErrors)
                                    <div class="alert alert-danger">
                                        <ul>
                                            @foreach ($homeAreaErrors as $error)
                                                <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                            @endforeach
                                        </ul>
                                    </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select name="loan_giving_applicant_finance_cond[home_type][0]">
                                    <option value="" selected disabled>घरको किसिम चयन गर्नुहोस्</option>
                                    <option value="कच्ची" {{ old('loan_giving_applicant_finance_cond.home_type.0') == 'कच्ची' ? 'selected' : '' }}>कच्ची</option>
                                    <option value="पक्की" {{ old('loan_giving_applicant_finance_cond.home_type.0') == 'पक्की' ? 'selected' : '' }}>पक्की</option>
                                    <option value="अन्य" {{ old('loan_giving_applicant_finance_cond.home_type.0') == 'अन्य' ? 'selected' : '' }}>अन्य</option>
                                </select>                                
                                @php
                                $homeTypeErrors = $errors->get('loan_giving_applicant_finance_cond.home_type.*');
                            @endphp
                            @if ($homeTypeErrors)
                                <div class="alert alert-danger">
                                    <ul>
                                        @foreach ($homeTypeErrors as $error)
                                            <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                        @endforeach
                                    </ul>
                                </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" value="{{ old('loan_giving_applicant_finance_cond.home_storey.0') }}"
                                    id="" name="loan_giving_applicant_finance_cond[home_storey][]"
                                    class="input-text" autofocus min="1" required>
                                <small id="homestoreyHelp" class="form-text text-muted"></small>
                                @php
                                $homeStoreyErrors = $errors->get('loan_giving_applicant_finance_cond.home_storey.*');
                            @endphp
                            @if ($homeStoreyErrors)
                                <div class="alert alert-danger">
                                    <ul>
                                        @foreach ($homeStoreyErrors as $error)
                                            <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                        @endforeach
                                    </ul>
                                </div>
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                @php
                                $homeStateErrors = $errors->get('loan_giving_applicant_finance_cond.home_state.*');
                            @endphp
                            @if ($homeStateErrors)
                                <div class="alert alert-danger">
                                    <ul>
                                        @foreach ($homeStateErrors as $error)
                                            <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                        @endforeach
                                    </ul>
                                </div>
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                @php
                                $homeDistrictErrors = $errors->get('loan_giving_applicant_finance_cond.home_district.*');
                            @endphp
                            @if ($homeDistrictErrors)
                                <div class="alert alert-danger">
                                    <ul>
                                        @foreach ($homeDistrictErrors as $error)
                                            <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                        @endforeach
                                    </ul>
                                </div>
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                @php
                                $homeLocalErrors = $errors->get('loan_giving_applicant_finance_cond.home_local.*');
                            @endphp
                            @if ($homeLocalErrors)
                                <div class="alert alert-danger">
                                    <ul>
                                        @foreach ($homeLocalErrors as $error)
                                            <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                        @endforeach
                                    </ul>
                                </div>
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                @php
                                $homeWardErrors = $errors->get('loan_giving_applicant_finance_cond.home_ward.*');
                            @endphp
                            @if ($homeWardErrors)
                                <div class="alert alert-danger">
                                    <ul>
                                        @foreach ($homeWardErrors as $error)
                                            <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                        @endforeach
                                    </ul>
                                </div>
        ...
        <div class="row">
            <div class="col-6">
                <div class="form-group" data-input-type="land_kitta">
                    ...
                    <div class="input-group">
                        <input type="number" value="{{ old('loan_giving_applicant_finance_cond.land_kitta.0') }}" id=""
                            name="loan_giving_applicant_finance_cond[land_kitta][]" class="input-text" autofocus min="1" required>
                            @php
                            $landKittaErrors = $errors->get('loan_giving_applicant_finance_cond.land_kitta.*');
                        @endphp
                        @if ($landKittaErrors)
                            <div class="alert alert-danger">
                                <ul>
                                    @foreach ($landKittaErrors as $error)
                                        <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                    @endforeach
                                </ul>
                            </div>
            ...
            <div class="col-6">
                <div class="form-group" data-input-type="land_area">
                    ...
                    <div class="input-group">
                        <input type="text" value="{{ old('loan_giving_applicant_finance_cond.land_area.0') }}" id=""
                            name="loan_giving_applicant_finance_cond[land_area][]" class="input-text" autofocus min="1" required>
                            @php
                            $landAreaErrors = $errors->get('loan_giving_applicant_finance_cond.land_area.*');
                        @endphp
                        @if ($landAreaErrors)
                            <div class="alert alert-danger">
                                <ul>
                                    @foreach ($landAreaErrors as $error)
                                        <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                    @endforeach
                                </ul>
                            </div>
        ...
        <div class="row">
            <div class="col-3">
                <div class="form-group">
                    ...
                    @php
                    $landStateErrors = $errors->get('loan_giving_applicant_finance_cond.land_state.*');
                @endphp
                @if ($landStateErrors)
                    <div class="alert alert-danger">
                        <ul>
                            @foreach ($landStateErrors as $error)
                                <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                            @endforeach
                        </ul>
                    </div>
            ...
            <div class="col-3">
                <div class="form-group">
                    ...
                    <select id="e_district_id5" data-iteration="5"
                        ...
                        <option value="{{ old('loan_giving_applicant_finance_cond.land_district.0') }}">जिल्ला चयन गर्नुहोस्</option>
                    </select>
                    @php
                    $landDistrictErrors = $errors->get('loan_giving_applicant_finance_cond.land_district.*');
                @endphp
                @if ($landDistrictErrors)
                    <div class="alert alert-danger">
                        <ul>
                            @foreach ($landDistrictErrors as $error)
                                <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                            @endforeach
                        </ul>
                    </div>
            ...
            <div class="col-3">
                <div class="form-group">
                    ...
                    @php
                    $landLocalErrors = $errors->get('loan_giving_applicant_finance_cond.land_local.*');
                @endphp
                @if ($landLocalErrors)
                    <div class="alert alert-danger">
                        <ul>
                            @foreach ($landLocalErrors as $error)
                                <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                            @endforeach
                        </ul>
                    </div>
            ...
            <div class="col-3">
                <div class="form-group">
                    ...
                    @php
                    $landWardErrors = $errors->get('loan_giving_applicant_finance_cond.land_ward.*');
                @endphp
                @if ($landWardErrors)
                    <div class="alert alert-danger">
                        <ul>
                            @foreach ($landWardErrors as $error)
                                <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                            @endforeach
                        </ul>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="dropdown-container">
                                ...
                                @endif
                                @php
                                $vehicledescriptionErrors = $errors->get('loan_giving_applicant_finance_cond.vehicle_count.*');
                                @endphp
                                @if ($vehicledescriptionErrors)
                               <div class="alert alert-danger">
                             <ul>
                            @foreach ($vehicledescriptionErrors as $error)
                                <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                            @endforeach
                        </ul>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="dropdown-container">
                                ...
                                @endif
                                @php
                                $amountassetErrors = $errors->get('loan_giving_applicant_finance_cond.amount_asset_description.*');
                                $amountassetcountErrors = $errors->get('loan_giving_applicant_finance_cond.amount_asset_count.*');
                                @endphp
                                @if ($amountassetErrors)
                               <div class="alert alert-danger">
                             <ul>
                            @foreach ($amountassetErrors as $error)
                                <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                            @endforeach
                        </ul>
                    </div>
                @endif
                                @if ($amountassetcountErrors)
                               <div class="alert alert-danger">
                             <ul>
                            @foreach ($amountassetcountErrors as $error)
                                <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                            @endforeach
                        </ul>
                    </div>
...
<div class="row bank-account-details">
    <div class="col-3">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="loan_giving_applicant_finance_cond[finance_name][]" value="{{ old('loan_giving_applicant_finance_cond.finance_name.0') }}" placeholder="">
    ...
    <div class="col-3">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="loan_giving_applicant_finance_cond[finance_branch][]" value="{{ old('loan_giving_applicant_finance_cond.finance_branch.0') }}" placeholder="">
        </div>
    </div>
    <div class="col-3">
        <div class="form-group">
            <label for="accountissue-datepicker">इ. खाता खोलेको मिति</label>
            <input type="text" class="form-control" name="loan_giving_applicant_finance_cond[finance_accountissue_date][]" value="{{ old('loan_giving_applicant_finance_cond.finance_accountissue_date.0') }}" id="accountissue-datepicker" placeholder="">
        </div>
    </div>
    <div class="col-3">
        <div class="form-group">
            ...
            <div class="input-group">
                <input type="text" class="form-control" name="loan_giving_applicant_finance_cond[finance_data][]" value="{{ old('loan_giving_applicant_finance_cond.finance_data.0') }}"placeholder="">
...
<div class="row loan-details">
    <div class="col-3">
        <div class="form-group">
            <label for="">अ. संस्थाको नाम</label>
            <input type="text" class="form-control" name="loan_giving_applicant_finance_cond[loan_finance_name][]" value="{{ old('loan_giving_applicant_finance_cond.loan_finance_name.0') }}"placeholder="">
        </div>
    </div>
    <div class="col-3">
        <div class="form-group">
            <label for="">आ. शाखा</label>
            <input type="text" class="form-control" name="loan_giving_applicant_finance_cond[loan_finance_branch][]" value="{{ old('loan_giving_applicant_finance_cond.loan_finance_branch.0') }}" placeholder="">
        </div>
    </div>
    <div class="col-3">
        <div class="form-group">
            <label for="account_datepicker">इ. कर्जाको दायित्व</label>
            <input type="text" class="form-control" name="loan_giving_applicant_finance_cond[loan_finance_liability][]" value="{{ old('loan_giving_applicant_finance_cond.loan_finance_liability.0') }}"placeholder="">
        </div>
    </div>
    <div class="col-3">
        <div class="form-group">
            ...
            <div class="input-group">
                <input type="number" class="form-control" name="loan_giving_applicant_finance_cond[loan_finance_remainingpay][]" value="{{ old('loan_giving_applicant_finance_cond.loan_finance_remainingpay.0') }}" placeholder="" min="1">
                <div class="input-group-append">
                    <button class="btn btn-outline-secondary add-fields" type="button">+</button>
                </div>
            </div>
...
<script>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    value="{{ old('loan_giving_debtor_application_detail.debtor_name') }}"
                                    id="applicant_name" name="loan_giving_debtor_application_detail[debtor_name]"
                                    class="input-text" autofocus>
                                    @if ($errors->has('loan_giving_debtor_application_detail.debtor_name'))
                                   <div class="alert alert-danger">
                                       <ul>
                                           @foreach ($errors->get('loan_giving_debtor_application_detail.debtor_name') as $error)
                                           <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                           @endforeach
                                       </ul>
                                   </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="" id=""
                                    ...
                                    autofocus>
                                    @if ($errors->has('loan_giving_debtor_application_detail.debtor_local'))
                                   <div class="alert alert-danger">
                                       <ul>
                                           @foreach ($errors->get('loan_giving_debtor_application_detail.debtor_local') as $error)
                                           <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                           @endforeach
                                       </ul>
                                   </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    value="{{ old('loan_giving_debtor_application_detail.debit_date') }}"
                                    id="debit-datepicker" name="loan_giving_debtor_application_detail[debit_date]"
                                    class="input-text" autofocus>
                                    @if ($errors->has('loan_giving_debtor_application_detail.debit_date'))
                                   <div class="alert alert-danger">
                                       <ul>
                                           @foreach ($errors->get('loan_giving_debtor_application_detail.debit_date') as $error)
                                           <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                           @endforeach
                                       </ul>
                                   </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number"
                                    value="{{ old('loan_giving_debtor_application_detail.debit_amount') }}"
                                    id="" name="loan_giving_debtor_application_detail[debit_amount]"
                                    class="input-text" autofocus min="1">
                                    @if ($errors->has('loan_giving_debtor_application_detail.debit_amount'))
                                   <div class="alert alert-danger">
                                       <ul>
                                           @foreach ($errors->get('loan_giving_debtor_application_detail.debit_amount') as $error)
                                           <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                           @endforeach
                                       </ul>
                                   </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <p class="listing_checkbox">
                                    अ. नगद दिएको
                                    <input type="checkbox" name="loan_giving_debtor_application_detail[debit_medium][]"
                                           value="नगद दिएको" {{ (is_array(old('loan_giving_debtor_application_detail.debit_medium')) && in_array('नगद दिएको', old('loan_giving_debtor_application_detail.debit_medium'))) ? 'checked' : '' }}>
                                    <br>
                                    आ. ऋणीको जग्गा राजिनामा पारित गराइएको
                                    <input type="checkbox" name="loan_giving_debtor_application_detail[debit_medium][]"
                                           value="ऋणीको जग्गा राजिनामा पारित गराइएको" {{ (is_array(old('loan_giving_debtor_application_detail.debit_medium')) && in_array('ऋणीको जग्गा राजिनामा पारित गराइएको', old('loan_giving_debtor_application_detail.debit_medium'))) ? 'checked' : '' }}>
                                    <br>
                                    इ. ऋणीको जग्गा दृष्टिबन्धक गराइएको
                                    <input type="checkbox" name="loan_giving_debtor_application_detail[debit_medium][]"
                                           value="ऋणीको जग्गा दृष्टिबन्धक गराइएको" {{ (is_array(old('loan_giving_debtor_application_detail.debit_medium')) && in_array('ऋणीको जग्गा दृष्टिबन्धक गराइएको', old('loan_giving_debtor_application_detail.debit_medium'))) ? 'checked' : '' }}>
                                    <br>
                                    ई. ऋणी सँग लिखत/तमसुक गराएको वा नगराएको
                                    <input type="checkbox" name="loan_giving_debtor_application_detail[debit_medium][]"
                                           value="ऋणी सँग लिखत/तमसुक गराएको वा नगराएको" {{ (is_array(old('loan_giving_debtor_application_detail.debit_medium')) && in_array('ऋणी सँग लिखत/तमसुक गराएको वा नगराएको', old('loan_giving_debtor_application_detail.debit_medium'))) ? 'checked' : '' }}>
                                    <br>
                                    उ. चेकको माध्यमबाट ऋण दिएको
                                    <input type="checkbox" name="loan_giving_debtor_application_detail[debit_medium][]"
                                           value="चेकको माध्यमबाट ऋण दिएको" {{ (is_array(old('loan_giving_debtor_application_detail.debit_medium')) && in_array('चेकको माध्यमबाट ऋण दिएको', old('loan_giving_debtor_application_detail.debit_medium'))) ? 'checked' : '' }}>
                                    <br>
                                    ऊ. ऋण दिँदा ऋणी सँग लिइएको
                                    <input type="checkbox" name="loan_giving_debtor_application_detail[debit_medium][]"
                                           value="ऋण दिँदा ऋणी सँग लिइएको" {{ (is_array(old('loan_giving_debtor_application_detail.debit_medium')) && in_array('ऋण दिँदा ऋणी सँग लिइएको', old('loan_giving_debtor_application_detail.debit_medium'))) ? 'checked' : '' }}>
                                    <br>
                                    ऋ. लिखत/तमसुक गराई ऋणीसँग चेक लिएको
                                    <input type="checkbox" name="loan_giving_debtor_application_detail[debit_medium][]"
                                           value="लिखत/तमसुक गराई ऋणीसँग चेक लिएको" {{ (is_array(old('loan_giving_debtor_application_detail.debit_medium')) && in_array('लिखत/तमसुक गराई ऋणीसँग चेक लिएको', old('loan_giving_debtor_application_detail.debit_medium'))) ? 'checked' : '' }}>
                                    <br>
                                </p>
                                @if ($errors->has('loan_giving_debtor_application_detail.debit_medium'))
                                   <div class="alert alert-danger">
                                       <ul>
                                           @foreach ($errors->get('loan_giving_debtor_application_detail.debit_medium') as $error)
                                           <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                           @endforeach
                                       </ul>
                                   </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number"
                                    value="{{ old('loan_giving_debtor_application_detail.other_debtors_no') }}"
                                    id="" name="loan_giving_debtor_application_detail[other_debtors_no]"
                                    class="input-text" autofocus min="1">
                                    @if ($errors->has('loan_giving_debtor_application_detail.debtors_no'))
                                   <div class="alert alert-danger">
                                       <ul>
                                           @foreach ($errors->get('loan_giving_debtor_application_detail.debtors_no') as $error)
                                           <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                           @endforeach
                                       </ul>
                                   </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number"
                                    value="{{ old('loan_giving_debtor_application_detail.other_debtors_amount') }}"
                                    id="" name="loan_giving_debtor_application_detail[other_debtors_amount]"
                                    class="input-text" autofocus min="1">
                                    @if ($errors->has('loan_giving_debtor_application_detail.debtors_amount'))
                                   <div class="alert alert-danger">
                                       <ul>
                                           @foreach ($errors->get('loan_giving_debtor_application_detail.debtors_amount') as $error)
                                           <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                           @endforeach
                                       </ul>
                                   </div>
                ...
                <div class="form-group">
                    ...
                    <select name="is_statement_register">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="radio" id="is_statement_register_yes"
                                        ...
                                        {{ old('loan_giving_debtor_application_detail.is_statement_register') == '1' ? 'checked' : '' }}
                                    ...
                                    <input type="radio" id="is_statement_register_no"
                                        ...
                                        {{ old('loan_giving_debtor_application_detail.is_statement_register') == '0' ? 'checked' : '' }}
                                        onclick="hideStatementRegisterNo()">
                                    <label for="is_statement_register_no">नभएको</label>
                                    @if ($errors->has('loan_giving_debtor_application_detail.is_statement_register'))
                                   <div class="alert alert-danger">
                                       <ul>
                                           @foreach ($errors->get('loan_giving_debtor_application_detail.is_statement_register') as $error)
                                           <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                           @endforeach
                                       </ul>
                                   </div>
                        ...
                        <div class="col-6" id="statementRegisterNoContainer" style="display: none;">
                            <div class="form-group">
                                ...
                                <input type="number"
                                    value="{{ old('loan_giving_debtor_application_detail.statement_register_no') }}"
                                    id="statement_register_no"
                                    name="loan_giving_debtor_application_detail[statement_register_no]" class="input-text"
                                    autofocus min="1">
                                    @if ($errors->has('loan_giving_debtor_application_detail.statement_register_no'))
                                   <div class="alert alert-danger">
                                       <ul>
                                           @foreach ($errors->get('loan_giving_debtor_application_detail.statement_register_no') as $error)
                                           <li>कृपया यो क्षेत्र भर्नुहोस्</li>
                                           @endforeach
                                       </ul>
                                   </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number"
                                    value="{{ old('loan_giving_transaction_application_detail.comp_amt_rem_prin') }}"
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number"
                                    value="{{ old('loan_giving_transaction_application_detail.comp_amt_rem_interest') }}"
                                    id=""
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    value="{{ old('loan_giving_application_other_details.loan_landrestrict_owner') }}"
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    value="{{ old('loan_giving_application_other_details.loan_taking_person_name') }}"
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type=""
                                    value="{{ old('loan_giving_application_other_details.land_passed_name') }}"
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    value="{{ old('loan_giving_application_other_details.registered_person_relation') }}"
                                    id=""
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number"
                                    value="{{ old('loan_giving_application_other_details.landrestrict_kitta.0') }}"
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    value="{{ old('loan_giving_application_other_details.landrestrict_area.0') }}"
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    value="{{ old('loan_giving_application_other_details.landrestrict_registration_date') }}"
                    ...
                    <body>
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <span class="application_main_title">७. ऋण/कर्जा दिएको बखत ऋणी सँग बैंक चेक लेखाई
                                    ...
                                    <div>
                                        <input type="radio" id="loan_cheque_shown_yes"
                                            ...
                                            {{ old('loan_giving_application_other_details.is_loan_cheque_shown') == '1' ? 'checked' : '' }}>
                                    ...
                                    <div>
                                        <input type="radio" id="loan_cheque_shown_no"
                                            ...
                                            {{ old('loan_giving_application_other_details.is_loan_cheque_shown') == '0' ? 'checked' : '' }}>
                            ...
                            <div class="col-6" id="chequeFields" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        value="{{ old('loan_giving_application_other_details.cheque_giving_person') }}"
                            ...
                            <div class="col-6" id="chequeFields2" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        value="{{ old('loan_giving_application_other_details.cheque_receiving_person') }}"
                            ...
                            <div class="col-6" id="chequeFields3" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        value="{{ old('loan_giving_application_other_details.cheque_issue_date') }}"
                            ...
                            <div class="col-6" id="chequeFields4" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        value="{{ old('loan_giving_application_other_details.cheque_bounce_date') }}"
                            ...
                            <div class="col-6" id="chequeFields5" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        value="{{ old('loan_giving_application_other_details.cheque_detail_amount') }}"
                            ...
                            <div class="col-6" id="chequeFields6" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <textarea name="loan_giving_application_other_details[cheque_other_details]">{{ old('loan_giving_application_other_details.cheque_other_details') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <span class="application_main_title">८. ऋण/कर्जा कारोवारको सम्बन्धमा निज ऋणीको विरुद्धमा अदालतमा मुद्दा परेको:<span class="star">*</span></label>
                                    <div>
                            ...
                            <div class="col-4" id="courtCaseFields7"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="loan_giving_application_other_details[court_case_state_name]">
                                        ...
                                        <option
                                            {{ old('loan_giving_application_other_details.court_case_state_name') == 'विचाराधीन अवस्थामा रहेको' ? 'selected' : '' }}>
                                            विचाराधीन रहेको</option>
                                        <option
                                            {{ old('loan_giving_application_other_details.court_case_state_name') == 'फैसला भैसकेको' ? 'selected' : '' }}>
                                            फैसला भैसकेको</option>
                                        <option
                                            {{ old('loan_giving_application_other_details.court_case_state_name') == 'फैसला भै फैसला कार्यान्वयन भई सकेको' ? 'selected' : '' }}>
                                            फैसला कार्यान्वयन भई सकेको</option>
                                        <option
                                            {{ old('loan_giving_application_other_details.court_case_state_name') == 'फैसला भै फैसला कार्यान्वयनको क्रममा रहेको' ? 'selected' : '' }}>
                                            फैसला कार्यान्वयनको क्रममा रहेको</option>
                                        <option
                                            {{ old('loan_giving_application_other_details.court_case_state_name') == 'फैसला भै फैसला कार्यान्वयन हुन बाँकी रहेको' ? 'selected' : '' }}>
                                            फैसला कार्यान्वयन नभएको</option>
                                        <option
                                            {{ old('loan_giving_application_other_details.court_case_state_name') == 'आशिंक रुपमा फैसला कार्यान्वयन भएको' ? 'selected' : '' }}>
                            ...
                            <div class="col-4" id="courtCaseFields8"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        value="{{ old('loan_giving_application_other_details.court_case_subject') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="radio" id="amount_short_person_injail_yes"
                                            ...
                                            {{ old('loan_giving_application_other_details.is_amount_short_person_injail') == '1' ? 'checked' : '' }}>
                                    ...
                                    <div>
                                        <input type="radio" id="amount_short_person_injail_no"
                                            ...
                                            {{ old('loan_giving_application_other_details.is_amount_short_person_injail') == '0' ? 'checked' : '' }}>
                            ...
                            <div class="col-12" id="courtCaseFields11"
                                style="{{ old('loan_giving_application_other_details.is_court_case_pending') == '1' ? 'display: block;' : 'display: none;' }}">
                                <div class="form-group">
                                    <span class="application_main_title">९. अदालतबाट मुद्दा फैसला भइसकेको भए: </span>
                                    <div>
                                        <input type="radio" id="court_case_done_yes"
                                            name="loan_giving_application_other_details[is_court_case_done]"
                                            value="1" onclick="showCourtCaseDoneFields()"
                                            {{ old('loan_giving_application_other_details.is_court_case_done') == '1' ? 'checked' : '' }}>
                                    ...
                                    <div>
                                        <input type="radio" id="court_case_done_no"
                                            name="loan_giving_application_other_details[is_court_case_done]"
                                            value="0" onclick="hideCourtCaseDoneFields()"
                                            {{ old('loan_giving_application_other_details.is_court_case_done') == '0' ? 'checked' : '' }}>
    ...
    function hideCourtCaseDoneFields() {
        ...
        document.getElementById('courtCaseDoneFields8').style.display = 'none';
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <span class="application_main_title">१०. कर्जा लेनदेनको क्रममा दृष्टिबन्धक/राजीनामा पारित
                                        गरेको भए घर/जग्गा हाल कसले भोगचलन गरिरहेको छ?</span>
                                    <textarea name="loan_giving_application_other_details[landrestricted_usedby_now]"
                                    >{{ old('loan_giving_application_other_details.landrestricted_usedby_now') }}</textarea>
                                    <autofocus>
                                </div>
                            </div>
                        ...
                        {{-- Row Starts --}}
                        <div class="row">
                            <span class="application_main_title">११.रजिष्ट्रेशन पारित गर्दा छुट्टै शर्तनामाको कागज गरिएको:<span class="star">*</span></span>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for=""></label>
                                    <div>
                                        <label>
                                            <input type="radio"
                                                ...
                                                {{ old('loan_giving_application_other_details.is_when_registered_otherdocs') == '1' ? 'checked' : '' }}>
                                            थियो
                                        </label>
                                        <label>
                                            <input type="radio"
                                                ...
                                                {{ old('loan_giving_application_other_details.is_when_registered_otherdocs') == '0' ? 'checked' : '' }}>
                                            थिएन
                                        </label>
                                    </div>
                                </div>
                               ...
                               <div id="textareas">
                                   <div style="display: flex; align-items: center; margin-bottom: 10px;">
                                       <textarea name="loan_giving_application_other_details[when_registered_othercondition_name][]"
                                                 class="form-control equal-height" style="height: 20px; flex-grow: 1;">{{ old('loan_giving_application_other_details.when_registered_othercondition_name[]') }}</textarea>
                            ...
                            <div class="row m-0 p-0">
                                <div class="form-group"><br>
                                    ...
                                    <textarea name="loan_giving_application_other_details[other_details_in_transaction]"
                                        class="form-control equal-height"style="height: 20px;">{{ old('loan_giving_application_other_details.other_details_in_transaction') }}</textarea>
                                </div>
                                {{-- Another Row Starts --}}
                                <div class="row">
                                    <div class="col-12 mt-3">
                                        <div class="form-group">
                                            <label class=""><span class="application_main_title">१३. यो निवेदनको व्यहोरा पुष्टि गर्ने निम्न कागजातको फोटोकपी यसैसाथ संलग्न गरेको छु।</span></label>
                                            <div id="document-container">
                                                <div class="input-group mb-2">
                                                    <textarea name="loan_giving_application_other_details[application_attached_documents][]" class="form-control equal-height" autofocus>{{ old('loan_giving_application_other_details.application_attached_documents.0') }}</textarea>
                                                    <input type="file" name="loan_giving_application_other_details[application_document_file][]" class="form-control equal-height ml-2" value="{{ old('loan_giving_application_other_details.application_document_file.0') }}">
                                                    <div class="input-group-append">
            ...
            $(document).on('click', '.remove-textarea', function() {
                $(this).closest('.input-group').remove();
                                ...
                                <div class="row">
                                    ...
                                    <label class=""><span class="application_main_title">१४. माथि लेखिएको व्यहोरा मैले जानेबुझे सम्म ठिक
                                        साँचो हो। यसमा फरक परे कानुन बमोजिम सहुँला बुझाँउला भनि सहिछाप गरिदिए:</span></label>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type=""
                                                value="{{ old('loan_giving_application_other_details.stamped_name') }}"
                                                id=""
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type=""
                                                value="{{ old('loan_giving_application_other_details.stamped_date') }}"
                                                id="stamp-datepicker"
    ...
    // Show error if the length is not 9 or 10 and hide otherwise
