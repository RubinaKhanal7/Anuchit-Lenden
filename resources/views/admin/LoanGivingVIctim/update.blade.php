                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <select id="occupation" name="loan_giving_applicant_basic_detail[applicant_occup]" class="form-control" autofocus>
                                ...
                                <option value="शिक्षक" {{ $loanGivingVictim->basicDetailRegistration->applicant_occup == 'शिक्षक' ? 'selected' : '' }}>शिक्षक</option>
                                <option value="अभियंता" {{$loanGivingVictim->basicDetailRegistration->applicant_occup == 'अभियंता' ? 'selected' : '' }}>अभियंता</option>
                                <option value="डॉक्टर" {{ $loanGivingVictim->basicDetailRegistration->applicant_occup == 'डॉक्टर' ? 'selected' : '' }}>डॉक्टर</option>
                                <option value="वकील" {{ $loanGivingVictim->basicDetailRegistration->applicant_occup == 'वकील' ? 'selected' : '' }}>वकील</option>
                                <option value="व्यवसाय" {{ $loanGivingVictim->basicDetailRegistration->applicant_occup == 'व्यवसाय' ? 'selected' : '' }}>व्यवसाय</option>
                                <option value="किसान" {{ $loanGivingVictim->basicDetailRegistration->applicant_occup == 'किसान' ? 'selected' : '' }}>किसान</option>
                                <option value="अन्य" {{ $loanGivingVictim->basicDetailRegistration->applicant_occup == 'अन्य' ? 'selected' : '' }}>अन्य</option>
                            </select>
                        </div>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="form-group" data-input-type="land_area">
                    ...
                    <div class="input-group">
                        <input type="text" value="{{ $loanGivingVictim->applicationFinance->land_area }}" id=""
