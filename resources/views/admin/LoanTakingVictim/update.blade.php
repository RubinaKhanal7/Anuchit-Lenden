...
@section('content')
    ...
    <form id="quickForm" novalidate="novalidate" method="POST" action="{{ url('admin/loantaking-victim/update/' . $loanTakingVictim->id) }}"
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="number" value="{{ $loanTakingVictim->basicDetailRegistration->applicant_fathers_no }}" 
                           ...
                           class="input-text" maxlength="10" placeholder="ex: ९८११११११११/०१-२३४५६८७" autofocus
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="number" value="{{ $loanTakingVictim->basicDetailRegistration->applicant_spouse_no }}" 
                        ...
                        class="input-text" autofocus maxlength="10" placeholder="ex: ९८११११११११/०१-२३४५६८७"
            ...
            <div class="col-4">
                <div class="form-group">
                    ...
                    <select id="occupation" name="loan_taking_applicant_basic_detail[applicant_occup]" class="form-control" autofocus>
                        <option  value="" selected disabled>पेशा/व्यवसाय चयन गर्नुहोस्</option>
                        <option value="शिक्षक" {{ $loanTakingVictim->basicDetailRegistration->applicant_occup == 'शिक्षक' ? 'selected' : '' }}>शिक्षक</option>
                        <option value="अभियंता" {{ $loanTakingVictim->basicDetailRegistration->applicant_occup == 'अभियंता' ? 'selected' : '' }}>अभियंता</option>
                        <option value="डॉक्टर" {{ $loanTakingVictim->basicDetailRegistration->applicant_occup == 'डॉक्टर' ? 'selected' : '' }}>डॉक्टर</option>
                        <option value="वकील" {{ $loanTakingVictim->basicDetailRegistration->applicant_occup == 'वकील' ? 'selected' : '' }}>वकील</option>
                        <option value="व्यवसाय" {{ $loanTakingVictim->basicDetailRegistration->applicant_occup == 'व्यवसाय' ? 'selected' : '' }}>व्यवसाय</option>
                        <option value="किसान" {{ $loanTakingVictim->basicDetailRegistration->applicant_occup == 'किसान' ? 'selected' : '' }}>किसान</option>
                        <option value="अन्य" {{ $loanTakingVictim->basicDetailRegistration->applicant_occup == 'अन्य' ? 'selected' : '' }}>अन्य</option>
                    </select>
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <select id="" name="loan_taking_applicant_basic_detail[applicant_edu]"
                        ...
                        <option
                            ...
                            उच्च शिक्षा</option>
                            <option
                            {{ $loanTakingVictim->basicDetailRegistration->applicant_edu == 'निराक्षर' ? 'selected' : '' }}>
                            निराक्षर</option>
                    </select>
                </div>
            </div>
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <select id="occupation" name="loan_taking_opponent_detail[opponent_occupation]" class="form-control" autofocus>
                        ...
                        <option value="शिक्षक" {{ $loanTakingVictim->basicOpponentDetailRegistration->opponent_occupation == 'शिक्षक' ? 'selected' : '' }}>शिक्षक</option>
                        <option value="अभियंता" {{$loanTakingVictim->basicOpponentDetailRegistration->opponent_occupation == 'अभियंता' ? 'selected' : '' }}>अभियंता</option>
                        <option value="डॉक्टर" {{ $loanTakingVictim->basicOpponentDetailRegistration->opponent_occupation == 'डॉक्टर' ? 'selected' : '' }}>डॉक्टर</option>
                        <option value="वकील" {{ $loanTakingVictim->basicOpponentDetailRegistration->opponent_occupation == 'वकील' ? 'selected' : '' }}>वकील</option>
                        <option value="व्यवसाय" {{ $loanTakingVictim->basicOpponentDetailRegistration->opponent_occupation == 'व्यवसाय' ? 'selected' : '' }}>व्यवसाय</option>
                        <option value="किसान" {{ $loanTakingVictim->basicOpponentDetailRegistration->opponent_occupation == 'किसान' ? 'selected' : '' }}>किसान</option>
                        <option value="अन्य" {{ $loanTakingVictim->basicOpponentDetailRegistration->opponent_occupation == 'अन्य' ? 'selected' : '' }}>अन्य</option>
                    </select>
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <p class="listing_checkbox">
                        ...
                        (ऌ) अन्य सामाजिक व्यवहार चलाउन <input type="checkbox" name="loan_taking_loan_detail[loan_purpose][]"
                            ...
                            कर्मकाण्ड
                            <input type="checkbox" name="loan_taking_loan_detail[loan_purpose][]" value="अन्य"  {{ in_array('अन्य', $loanPurposes) ? 'checked' : '' }}>
                            अन्य
                        </div>
                        <script>
                ...
                <div id="form-container-1" class="row form-set">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input id="applicant_house_area_1" type="text" value="{{ $loanTakingVictim->additionalDetail->applicant_house_area}}" name="loan_taking_additional_detail[applicant_house_area][]" class="input-text" autofocus min="1">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
...
<div id="form-container-2" class="row form-set">
    <div class="col-6">
        <div class="form-group">
            ...
            <input id="applicant_land_kitta_no_1" type="number" value="{{ $loanTakingVictim->additionalDetail->applicant_land_kitta_no}}" name="loan_taking_additional_detail[applicant_land_kitta_no][]" class="input-text" autofocus>
        </div>
    </div>
    <div class="col-6">
        <div class="form-group">
            <label for="applicant_land_area_1">क्षेत्रफल</label>
            <input id="applicant_land_area_1" type="text" value="{{ $loanTakingVictim->additionalDetail->applicant_land_area }}" name="loan_taking_additional_detail[applicant_land_area][]" class="input-text" autofocus>
        </div>
    </div>
    <div class="col-3">
        <div class="form-group">
