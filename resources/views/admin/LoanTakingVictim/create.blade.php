            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="number" value="{{ old('loan_taking_applicant_basic_detail.applicant_fathers_no') }}"
                           ...
                           class="input-text" minlength="9" maxlength="10" placeholder="ex: ९८११११११११/०१-२३४५६८७" autofocus
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="number" value="{{ old('loan_taking_applicant_basic_detail.applicant_spouse_no') }}"
                           ...
                           class="input-text" autofocus minlength="9" maxlength="10" placeholder="ex: ९८११११११११/०१-२३४५६८७"
                           oninput="validatePhoneNumber(this, 'phoneNumberError2')">
                    <span id="phoneNumberError2" style="display: none; color: red;">
                        कृपया ९/१० अंकको सही फोन नंबर प्रविष्ट गर्नुहोस्।
                    </span>
                </div>
            </div>
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <select id="annual_income" name="loan_taking_applicant_basic_detail[applicant_annual_income]" class="form-control" autofocus required>
                        ...
                        <option {{ old('loan_taking_applicant_basic_detail.applicant_annual_income') == '१ लाख देखि  ५ लाख' ? 'selected' : '' }}>१ लाख देखि  ५ लाख</option>
                        <option {{ old('loan_taking_applicant_basic_detail.applicant_annual_income') == '५ लाख देखि १० लाख' ? 'selected' : '' }}>५ लाख देखि १० लाख</option>
                        <option {{ old('loan_taking_applicant_basic_detail.applicant_annual_income') == '१० लाख देखि  २० लाख' ? 'selected' : '' }}>१० लाख देखि  २० लाख</option>
                        <option {{ old('loan_taking_applicant_basic_detail.applicant_annual_income') == '२० लाख +' ? 'selected' : '' }}>२० लाख +</option>
                    </select>
            ...
            <div class="col-4">
                <div class="form-group">
                    ...
                    <select id="occupation" name="loan_taking_applicant_basic_detail[applicant_occup]" class="form-control" autofocus>
                        ...
                        <option value="शिक्षक" {{ old('loan_taking_applicant_basic_detail.applicant_occup') == 'शिक्षक' ? 'selected' : '' }}>शिक्षक</option>
                        <option value="अभियंता" {{ old('loan_taking_applicant_basic_detail.applicant_occup') == 'अभियंता' ? 'selected' : '' }}>अभियंता</option>
                        <option value="डॉक्टर" {{ old('loan_taking_applicant_basic_detail.applicant_occup') == 'डॉक्टर' ? 'selected' : '' }}>डॉक्टर</option>
                        <option value="वकील" {{ old('loan_taking_applicant_basic_detail.applicant_occup') == 'वकील' ? 'selected' : '' }}>वकील</option>
                        <option value="व्यवसाय" {{ old('loan_taking_applicant_basic_detail.applicant_occup') == 'व्यवसाय' ? 'selected' : '' }}>व्यवसाय</option>
                        <option value="किसान" {{ old('loan_taking_applicant_basic_detail.applicant_occup') == 'किसान' ? 'selected' : '' }}>किसान</option>
                        <option value="अन्य" {{ old('loan_taking_applicant_basic_detail.applicant_occup') == 'अन्य' ? 'selected' : '' }}>अन्य</option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select id="" name="loan_taking_applicant_basic_detail[applicant_edu]" class="form-control">
                        ...
                        <option
                            ...
                            उच्च शिक्षा</option>
                        <option
                            {{ old('loan_taking_applicant_basic_detail.applicant_edu') == 'निराक्षर' ? 'selected' : '' }}>
                            निराक्षर</option>
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="number" value="{{ old('loan_taking_opponent_detail.opponent_fathers_no') }}"
                           ...
                           class="input-text" autofocus placeholder="ex: ९८११११११११/०१-२३४५६८७"
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <select id="occupation" name="loan_taking_opponent_detail[opponent_occupation]" class="form-control" autofocus>
                        <option disabled selected value>पेशा/व्यवसाय चयन गर्नुहोस्</option>
                        <option {{ old('loan_taking_opponent_detail.opponent_occupation') == 'शिक्षक' ? 'selected' : '' }}>शिक्षक</option>
                        <option {{ old('loan_taking_opponent_detail.opponent_occupation') == 'अभियंता' ? 'selected' : '' }}>अभियंता</option>
                        <option {{ old('loan_taking_opponent_detail.opponent_occupation') == 'डॉक्टर' ? 'selected' : '' }}>डॉक्टर</option>
                        <option {{ old('loan_taking_opponent_detail.opponent_occupation') == 'वकील' ? 'selected' : '' }}>वकील</option>
                        <option {{ old('loan_taking_opponent_detail.opponent_occupation') == 'व्यवसाय' ? 'selected' : '' }}>व्यवसाय</option>
                        <option {{ old('loan_taking_opponent_detail.opponent_occupation') == 'किसान' ? 'selected' : '' }}>किसान</option>
                        <option {{ old('loan_taking_opponent_detail.opponent_occupation') == 'अन्य' ? 'selected' : '' }}>अन्य</option>
                    </select>
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="listing_checkbox">
                        ...
                        <div class="other-options" style="{{ old('loan_taking_loan_detail.loan_purpose[]', []) && in_array('अन्य सामाजिक व्यवहार चलाउन', old('loan_taking_loan_detail.loan_purpose', [])) ? '' : 'display: none;' }}">
                            ...
                            कर्मकाण्ड
                            <input type="checkbox" name="loan_taking_loan_detail[loan_purpose][]" value="अन्य"  {{ in_array('अन्य', old('loan_taking_loan_detail.loan_purpose', [])) ? 'checked' : '' }}>
                            अन्य
                        </div>
        ...
        <div class="row">
                ...
                <div id="form-container-1" class="row form-set">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input id="applicant_house_area_1" type="text" value="{{ old('loan_taking_additional_detail.applicant_house_area.0') }}" name="loan_taking_additional_detail[applicant_house_area][]" class="input-text" autofocus min="1">
                            @php
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <select id="applicant_house_type_1" name="loan_taking_additional_detail[applicant_house_type][]">
                                ...
                                <option value="कच्ची" {{ (old('loan_taking_additional_detail.applicant_house_type.0') == 'कच्ची') ? 'selected' : '' }}>कच्ची</option>
                                <option value="पक्की" {{ (old('loan_taking_additional_detail.applicant_house_type.0') == 'पक्की') ? 'selected' : '' }}>पक्की</option>
                                <option value="अन्य" {{ (old('loan_taking_additional_detail.applicant_house_type.0') == 'अन्य') ? 'selected' : '' }}>अन्य</option>
                            </select>                            
                            @php
                ...
                <div id="form-container-2" class="row form-set">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input id="applicant_land_area_1" type="text" value="{{ old('loan_taking_additional_detail.applicant_land_area.0') }}" name="loan_taking_additional_detail[applicant_land_area][]" class="input-text" autofocus>
                            @php
            ...
            <div class="row">
                    ...
                    <div class="field-group">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="" value="{{ old('loan_taking_additional_detail.applicant_org_name.0', '') }}" name="loan_taking_additional_detail[applicant_org_name][]" class="input-text" autofocus>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="" value="{{ old('loan_taking_additional_detail.applicant_finance_org_branch.0', '') }}" name="loan_taking_additional_detail[applicant_finance_org_branch][]" class="input-text" autofocus>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input value="{{ old('loan_taking_additional_detail.applicant_account_opening_date.0', '') }}" id="account-datepicker" name="loan_taking_additional_detail[applicant_account_opening_date][]" class="input-text" autofocus>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label for="">खातामा मैज्दात रकम</label>
                                <div class="input-group mb-3">
                                    <input type="number" value="{{ old('loan_taking_additional_detail.applicant_finance_amount.0', '') }}" id="account-datepicker" name="loan_taking_additional_detail[applicant_finance_amount][]" class="input-text form-control" autofocus pattern="\d+" min="1">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="d-flex justify-content-end">
                    <button type="button" class="btn btn-sm btn-primary" id="add-field">+</button>
                </div>
            </div>
...
function addWitnessField() {
    ...
    function cloneFieldGroup() {
        var $fieldGroup = $('.field-group:first').clone(true);
        $fieldGroup.find('input').val('');
        $fieldGroup.append('<div class="input-group-append"><button type="button" class="btn btn-danger remove-all-fields">-</button></div>');
        return $fieldGroup;
    }

    // Add field group on button click
    $('#add-field').click(function() {
        var $clonedFieldGroup = cloneFieldGroup();
        $('#field-container').append($clonedFieldGroup);
    });

    // Remove all cloned field groups
    $(document).on('click', '.remove-all-fields', function() {
        $(this).closest('.field-group').nextAll('.field-group').remove();
