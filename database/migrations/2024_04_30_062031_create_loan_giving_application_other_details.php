...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('loan_giving_application_other_details', function (Blueprint $table) {
            $table->id();
            $table->string('loan_landrestrict_owner')->nullable();
            $table->string('loan_taking_person_name')->nullable();
            $table->string('land_passed_name')->nullable();
            $table->string('registered_person_relation')->nullable();
            ...
            $table->text('landrestricted_usedby_now')->nullable();
