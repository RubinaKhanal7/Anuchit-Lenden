...
class LoanTakingVictimController extends Controller
{
    ...
    {
        $query = LoanTakingVictim::with([
            'basicDetailRegistration',
            'basicOpponentDetailRegistration',
            'loanDetail',
            'user' => function ($query) {
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $loanTakingVictims = $this->getForDataTable($request->all());

            return Datatables::of($loanTakingVictims)
                ->escapeColumns([])
                ->addColumn('applicant_name', function ($loanTakingVictim) {
                    return $loanTakingVictim->basicDetailRegistration->applicant_name ?? '';
                })
                ->addColumn('applicant_temp_local', function ($loanTakingVictim) {
                    return $loanTakingVictim->basicDetailRegistration->applicant_temp_local ?? '';
                })
                ->addColumn('applicant_occup', function ($loanTakingVictim) {
                    return $loanTakingVictim->basicDetailRegistration->applicant_occup ?? '';
                })
                ->addColumn('opponent_name', function ($loanTakingVictim) {
                    return $loanTakingVictim->basicOpponentDetailRegistration->opponent_name ?? '';
                })
                ->addColumn('loan_date', function ($loanTakingVictim) {
                    return $loanTakingVictim->loanDetail->loan_date ?? '';
                })
                ->addColumn('loan_location', function ($loanTakingVictim) {
                    return $loanTakingVictim->loanDetail->loan_location ?? '';
                })
                ->addColumn('loan_amount', function ($loanTakingVictim) {
                    return $loanTakingVictim->loanDetail->loan_amount ?? '';
                })
                ->addColumn('loan_medium', function ($loanTakingVictim) {
                    return $loanTakingVictim->loanDetail->loan_medium ?? '';
                })
                ->addColumn('register_by', function ($loanTakingVictim) {
                    return $loanTakingVictim->user->name;
                })
                ->addColumn('created_at', function ($loanTakingVictim) {
                    return $loanTakingVictim->created_at->diffForHumans();
                })
    ...
    public function create()
    {
        ...
        $page_title = 'अनुचित लेनदेन (मिटरब्याज) सम्बन्धी पीडितले भर्ने निवेदन फारम [फारम नं. १]';
    ...
    public function store(Request $request)
    {
        ...
        $validateLoanDetailData = $request->validate([
            ...
            'loan_taking_loan_detail.taken_loan_stamp_amount' => 'nullable|string|max:255',
            ...
            'loan_taking_loan_detail.land_stop_promise_who_name' => 'nullable|string|max:255',
        ...
        if ($request->has('loan_taking_loan_detail')) {
            ...
            $loanDetails = LoanTakingLoanDetail::create([
                ...
                'taken_loan_stamp_amount' => $loanDetailsData['taken_loan_stamp_amount'] ?? null,
                ...
                'land_stop_promise_who_name' => $loanDetailsData['land_stop_promise_who_name'] ?? null,
        ...
        $validateCourtDetailData = $request->validate([
            ...
            'loan_taking_court_detail.case_result_bigo' => 'nullable|string',
            'loan_taking_court_detail.case_result_fine' => 'nullable|string',
            'loan_taking_court_detail.case_result_jail' => 'nullable|string',
        ...
        $validateAdditionalDetailData = $request->validate([
            ...
            'loan_taking_additional_detail.applicant_org_name' => 'required|array|max:255',
            'loan_taking_additional_detail.applicant_finance_org_branch.*' => 'required|string|max:255',
            'loan_taking_additional_detail.applicant_finance_org_branch' => 'required|array|max:255',
            'loan_taking_additional_detail.applicant_account_opening_date.*' => 'required|string|max:255',
            'loan_taking_additional_detail.applicant_account_opening_date' => 'required|array|max:255',
            'loan_taking_additional_detail.applicant_finance_amount.*' => 'required|string|max:255',
            'loan_taking_additional_detail.applicant_finance_amount' => 'required|array|max:255',
            'loan_taking_additional_detail.transaction_actual_interest' => 'nullable|string',
        ...
        if ($request->has('loan_taking_additional_detail')) {
            ...
            $additionalDetails = LoanTakingAdditionalDetail::create([
                ...
                'applicant_org_name' => implode(',', $additionalDetailsData['applicant_org_name']),
                'applicant_finance_org_branch' => implode(',', $additionalDetailsData['applicant_finance_org_branch']),
                'applicant_account_opening_date' => implode(',', $additionalDetailsData['applicant_account_opening_date']),
                'applicant_finance_amount' => implode(',', $additionalDetailsData['applicant_finance_amount']),
            ...
            if ($request->has('loan_taking_additional_detail')) {
                ...
                $additionalDetail = LoanTakingAdditionalDetail::updateOrCreate(
                    ...
                    [
                        ...
                        'applicant_org_name' => implode(',', $additionalDetailData['applicant_org_name']),
                        'applicant_finance_org_branch' => implode(',', $additionalDetailData['applicant_finance_org_branch']),
                        'applicant_account_opening_date' => implode(',', $additionalDetailData['applicant_account_opening_date']),
                        'applicant_finance_amount' => implode(',', $additionalDetailData['applicant_finance_amount']),
